  ...
  return knex('articles').del()
    .then(function () {
      ...
      return knex('articles').insert([
        {title: 'My Fat Cat', author: "I don't have a cat.", body: 'If I had a cat, it would be a fat cat.  Just kidding.  It would be a healthy cat.', urlTitle: "My%20Fat%20Cat%20"},
